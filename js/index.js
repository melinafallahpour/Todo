...
if (!localStorage.getItem('todos')) {
    todos.home.push(toDosManager.createToDo("brush teeth", "low", "2023-12-12", " with colgate", "home", true));
    todos.home.push(toDosManager.createToDo("get dressed", "high", "2023-11-11", "singlet cos its hot", "home"));
    todos.home.push(toDosManager.createToDo("feed jimmy", "medium", "2023-12-09", "only the finest bickies", "home", true));

    todos.today.push(toDosManager.createToDo("get a haircut", "medium", "2023-08-08","","today"));
    todos.today.push(toDosManager.createToDo("cook dinner", "medium", "2023-08-08", "juicy steak", "today", true));

    todos.week.push(toDosManager.createToDo("sport", "medium", "2023-08-08", "", "week"));

    todos.Gym.push(toDosManager.createToDo("swim", "medium", "2023-08-08", "", "Gym", true));
    todos.Gym.push(toDosManager.createToDo("walk", "high", "2023-08-08", "", "Gym"));
    todos.Gym.push(toDosManager.createToDo("weights", "low", "2023-08-08", "", "Gym"));
    
    todos.Study.push(toDosManager.createToDo("learn webkit", "high", "2023-08-08", "", "Study", true));
    todos.Study.push(toDosManager.createToDo("learn react", "medium", "2023-08-08", "", "Study"));

    todos.Work.push(toDosManager.createToDo("get that report on johnson's desk", "low", "2023-08-08", "", "Work"));
}
